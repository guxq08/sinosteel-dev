...
import {addIndexDefinitionService} from 'services';

import moment from 'moment'; 

export default class IndexDefinitionAddView extends AddView
{
    constructor(props)
    {
        super(props);

        this.addButtonName = "新增指标定义"; //“新增”按钮的名称
        this.addPath = addIndexDefinitionService; //负责处理新增命令的url
    }
